...
?>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Add Branch Country/</span> New Branches' Country</h4>

              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-2">
                    <h5 class="card-header">Branch Country Details</h5>
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="Operations/Country_crud.php">
                        <div class="row">
                          <div class="mb-3 col-md-12">
                            <label for="countryname" class="form-label">Branch Country</label>
                            <input
                              class="form-control"
                              type="text"
                              id="countryname"
                              name="countryname"
                              placeholder="Name of Branch's Country"
                              value=""
                              autofocus
                            />
                          </div>
                        ...
                        <div class="mt-2">
                          <input type="submit" class="btn btn-primary me-2" name="addcountry" value="Save changes">
    ...
    New Country has been <b>Added</b> Sucessfully!
    </div>
<?php
...
function myGreeting() {
  ...
  window.location.href='Add Branch_country.php';
