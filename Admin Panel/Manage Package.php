...
?>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Package /</span>View Packages</h4>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                       ...
                       <tr>
                        ...
                        <td><strong><?= $getdata['amount_cate'] ?></strong></td>
                        <td><strong><?= $getdata['Days'] ?></strong></td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="Edit Package.php?editid=<?= $getdata['package_id'] ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="Operations/Package_crud.php?delid=<?= $getdata['package_id']?>" onclick="return confirm('Are you Sure you want to delete?'); return false;"
    ...
    Package has been <b>Deleted</b> Sucessfully!
    </div>
    ...
    Package has been <b>Updated</b> Sucessfully!
    </div>
<?php
...
function myGreeting() {
  ...
  function myGreeting() {
    ...
    window.location.href='Manage Package.php';
