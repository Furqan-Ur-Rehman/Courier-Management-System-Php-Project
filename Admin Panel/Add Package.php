...
?>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Add Package /</span> New Packages</h4>
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="Operations/Package_crud.php">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="amountcate" class="form-label">Amount Cate</label>
                            <input class="form-control" type="text" name="amountcate" id="amountcate" value="" placeholder="200.00"/>
                          </div>
                        ...
                        <div class="mt-2">
                          <input type="submit" class="btn btn-primary me-2" name="addpackage" value="Save changes">
    ...
    Package has been <b>Added</b> Sucessfully!
    </div>
<?php
